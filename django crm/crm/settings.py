...
SECRET_KEY = 'ar1j_y15wh4=9)nuz6mtm&1n0j$$bo4_+pbac0wjnez5-54pa-'
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.yugabytedb",
        "NAME": os.environ["nibin"],
        "USER": os.environ["admin"],
        "PASSWORD": os.environ["Qs2iiK45FDwRwtQN-rQB_SFckZm69i"],
        "HOST": os.environ["us-east-1.950351cd-f3fa-4535-94d2-b9e222b4d6eb.aws.ybdb.io  "],
        "PORT": os.environ["54339042"],
    }
}
