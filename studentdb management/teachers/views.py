...
def teachers_view(request):
    ...
    # Calculate average pass percentage for each teacher
    teacher_data = []
    for teacher in teachers:
        avg_pass_percentage = teacher.student_set.aggregate(avg_pass_percentage=models.Avg('pass_percentage'))['avg_pass_percentage']
        teacher_data.append({
            'teacher': teacher,
            'avg_pass_percentage': avg_pass_percentage
        })

    return render(request, 'teachers/teacher_list.html', {'teacher_data': teacher_data})
